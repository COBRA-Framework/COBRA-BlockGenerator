...
public class ModelExport
{
    ...
    private int writeModelFile(List<Block> models, File file) throws Exception
    {
        ...
        try
        {
            ...
            xmlIntroductionComments = xmlIntroductionComments.concat("<!-- Copyright (c) 2016-" + Calendar.getInstance().get(Calendar.YEAR) + " Thomas Huybrechts, IDLab, University of Antwerp - imec, Belgium. All rights reserved. -->" + eol);
